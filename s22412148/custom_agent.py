...
class my_agent(Agent):
    ...
    def new_game(self, number_of_players, player_number, spies):
        ...
        for i in range(self.number_of_players):
            if i != self.player_number:
                self.player_info[i] = {"assistedSpies": 0, "spyBehaviour": 0, "resistanceBehaviour": 0} 
        ...
        self.betrays_required = self.fails_required[self.number_of_players][self.round_number-1]
    ...
    def vote(self, mission, proposer):
        ...
        if self.spy ==  True:
            ...
            # If spies only need 1 more win and we have enough spies in the mission, accept the mission
                ...
                return bool(len([s for s in mission if s in self.other_spies])>= self.betrays_required and )
        else:
    ...
    def betray(self, mission, proposer):
        ...
        if spy_num > self.betrays_required:
            ...
            missionRating = float(spy_num/self.betrays_required) * 0.70 # Assuming spies will betray 70% of the time
        ...
        # Mission failed
            ...
            if num_fails == self.spy_count[self.number_of_players]:
                ...
                for p in range(self.number_of_players):
                    ...
                    if p in mission and self.spy_rating[p] > 0 and p != self.player_number:

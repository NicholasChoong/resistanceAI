...
def _update_probabilities(self, mission, fails_occurred):
    ...
    self.non_missionCombination = _combination_calc(self, not_in_mission, (self.number_of_spies+1-fails_occurred))
...
class my_agent(Agent):
    ...
    def new_game(self, number_of_players, player_number, spies):
        ...
        print("NUMBER OF PLAYERS: " + str(self.number_of_players))
